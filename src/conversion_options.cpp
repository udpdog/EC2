...
const std::set<std::wstring> kFormatsWithAdvancedOptions = {L"avif", L"pdf"};
...
std::wstring fitModeName(FitMode mode) {
    switch (mode) {
        case FitMode::Max: return L"max";
        case FitMode::Crop: return L"crop";
        case FitMode::Scale: return L"scale";
    }
    return L"inconnu";
}
