...
int wmain(int argc,wchar_t* argv[]){
 ...
 }else{o.output=fs::absolute(o.output,e);if(e){std::wcerr<<L"Erreur : sortie invalide.\n";return 3;}o.output.replace_extension(L"."+o.format);}
 if(!fs::exists(o.output.parent_path(),e)){std::wcerr<<L"Erreur : dossier de sortie introuvable.\n";return 3;}
 if(fs::exists(o.output,e)&&!o.force){std::wcerr<<L"Erreur : le fichier existe deja. Ajoutez --force.\n";return 4;}
 std::wstring magick;
