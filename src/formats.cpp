...
const std::set<std::wstring> inputFormats = {
	...
	L"mrw",L"nef",L"odg",L"orf",L"pef",L"png",L"ppm",L"ps",L"psb",L"psd",
	L"pub",L"raf",L"raw",L"rw2",L"tga",L"tif",L"tiff",L"webp",L"x3f",L"xcf",L"xps"
};

const std::set<std::wstring> outputFormats = {
	L"avif",L"bmp",L"eps",L"gif",L"ico",L"jpg",L"pdf",L"png",L"ps",L"psd",L"tiff",L"webp"
};
}
...
bool isSupportedInputFormat(const std::wstring& value) {
	return inputFormats.count(normalizeFormat(value))!=0;
}
bool isSupportedOutputFormat(const std::wstring& value) {
	return outputFormats.count(normalizeFormat(value))!=0;
}
